...
router.get("/getAll", verifyAuth, getAllUsers);

router.get("/getOrgsUser",verifyAuth,getAllOrgsOfUser)//

// add middler var for root & admin only
router.post("/inviteUser",verifyAuth,IsAdmin, inviteUser)//
//  remove user
router.delete("/removeUser",verifyAuth,IsAdmin,removeUser)//
// update access
router.put("/updateAccess",verifyAuth,IsAdmin,updateAccess)//
// accept invite
...
// ------------Customer support----------------------
// createQuery
router.post("/createQuery",verifyAuth,IsAdmin,createQuery);//
// updateQuery
router.put("/updateQuery",verifyAuth,IsAdmin,updateQuery);//
// deleteQuery
router.delete("/deleteQuery",verifyAuth,IsAdmin,deleteQuery)//
// getQuery
router.post("/getQuery",verifyAuth,getQuery)//
// getAllOrgQuery
router.post("/getAllOrgQuery",verifyAuth,getAllOrgQuery);//
// customerSupportChat
router.post("/customerSupportChat",verifyAuth,IsAdmin,customerSupportChat)//
